// Copyright (c) 2000-2024  Made to Order Software Corp.  All Rights Reserved
//
...
/** \file
 * \brief The basic XML libray is used to load basic XML files.
 *
...
{
    return BASIC_XML_VERSION_MAJOR;
}
...
{
    return BASIC_XML_VERSION_MINOR;
}
...
{
    return BASIC_XML_VERSION_PATCH;
}
...
{
    return BASIC_XML_VERSION_STRING;
}
